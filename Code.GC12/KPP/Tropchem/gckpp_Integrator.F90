...
SUBROUTINE INTEGRATE_10( TIN, TOUT, &
  ...
  ICNTRL_U, RCNTRL_U, ISTATUS_U, RSTATUS_U, IERR_U )
   ...
   CALL Rosenbrock_10(LU_NSEL_10,VAR,TIN,TOUT,ATOL,RTOL,&
          RCNTRL,ICNTRL,RSTATUS,ISTATUS,IERR)		
...
Stage: DO istage = 1, ros_S
	 ...
	 Ynew(1:N) = Y(1:N)
         ...
         END DO
         Tau = T + ros_Alpha(istage)*Direction*H
         CALL FunTemplate_10(Tau,Ynew,Fcn)
         ISTATUS(Nfun) = ISTATUS(Nfun) + 1
       END IF ! if istage == 1 elseif ros_NewF(istage)
       !slim: CALL WCOPY(N,Fcn,1,K(ioffset+1),1)
       K(ioffset+1:ioffset+N) = Fcn(1:N)
...
!~~~> Local variables
   ...
   Delta = SQRT(Roundoff)*MAX(DeltaMin,ABS(T))
   CALL FunTemplate_10(T+Delta,Y,dFdT)
   ISTATUS(Nfun) = ISTATUS(Nfun) + 1
   CALL WAXPY(N,(-ONE),Fcn0,1,dFdT,1)
   CALL WSCAL(N,(ONE/Delta),dFdT,1)
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE FunTemplate_10( T, Y, Ydot )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!  Template for the ODE function call.
!  Updates the rate coefficients (and possibly the fixed species) at each call
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!~~~> Local variables
   ...
   Told = TIME
   TIME = T
   CALL Fun_10( Y, FIX, RCONST, Ydot, LU_NSEL_10 )
   TIME = Told
...
!~~~> Local variables
    ...
    TIME = T
#ifdef FULL_ALGEBRA    
    CALL Jac_SP_10(Y, FIX, RCONST, JV)
    DO j=1,LU_NSEL_10
      DO i=1,LU_NSEL_10
         Jcb(i,j) = 0.0_dp
      END DO
    ...
    END DO
#else
    CALL Jac_SP_10( Y, FIX, RCONST, Jcb)
#endif   
    TIME = Told
